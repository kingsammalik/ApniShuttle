...
public class RoutesStopsAdapter extends RecyclerView.Adapter<RoutesStopsAdapter.MyviewHolder> {
    ...
    public RoutesStopsAdapter(RoutesLatLngActivity myRideActivity, List<GetStopsModel> myRidesModelList, String s, String latitude, String longitude) {
